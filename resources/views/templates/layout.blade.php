    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-right info", style="font-size: 20px">
                    <p>{{$objUser->name}} </p>

                </div>
                <div class="clearfix", style="font-size: 20px;padding: 10px">
                    <p class="text-info">{{$objUser->name}}@gmail.com</p>
                </div>
            ...
            <ul class="sidebar-menu" data-widget="tree">
                <li class=" active menu-open ">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/account"><i class="fa fa-bars"></i>Danh sách tài khoản </a></li>
                        <li><a href="/admin/account/add"><i class="fa fa-hand-o-right"></i> Thêm tài khoản</a></li>
                    </ul>
                </li>
                <li class=" active menu-open ">
                    <a href="#"><i class="fa fa-user-circle-o"></i> <span>Quản lý danh mục</span></a>
                    <ul class="treeview-menu">
                        <li><a href="/admin/category"><i class="fa fa-bars"></i> Danh sách danh mục</a></li>
                        <li><a href="/admin/category/add"><i class="fa fa-hand-o-right"></i> Thêm sản danh mục</a></li>
                    </ul>
                </li>
                <li class=" active menu-open ">
                    <a href="#"><i class="fa fa-archive"></i> <span>Quản lý sản phẩm</span></a>
                    <ul class="treeview-menu">
                        <li><a href="/admin/product"><i class="fa fa-bars"></i> Danh sách sản phẩm</a></li>
                        <li><a href="/admin/product/add"><i class="fa fa-hand-o-right"></i> Thêm sản phẩm</a></li>
                    </ul>
                </li>
                <li class=" active menu-open ">
                    <a href="#"><i class="fa fa-file"></i> <span>Quản lý banner</span></a>
                    <ul class="treeview-menu">
                        <li><a href="/admin/banner"><i class="fa fa-bars"></i> Danh sách banner</a></li>
                        <li><a href="/admin/banner/add"><i class="fa fa-hand-o-right"></i> Thêm banner</a></li>
                    </ul>
                </li>
                <li class=" active menu-open ">
                    <a href="#"><i class="fa fa-shopping-bag"></i> <span>Quản lý đơn hàng</span></a>
                    <ul class="treeview-menu">
                        <li><a href="/admin/cart"><i class="fa fa-bars"></i> Danh sách đơn hàng</a></li>
                    </ul>
                </li>
            </ul>
        </section>
