                    ...
                    <div class="col-xs-12" style="text-align:center;">
                        <div class="form-group">
                            ...
                            <a href="{{ url('/user') }}" class="btn btn-default btn-sm "><i class="fa fa-remove"></i>
                                Clear </a>
                            <a href="/admin/category/add" class="btn btn-info btn-sm"><i class="fa fa-user-plus" style="color:white;"></i>
                                Thêm mới</a>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($list as $item)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-danger"href="{{route('route_BackEnd_Category_Detail',['id'=>$item->id])}}">Sửa</a>
                                    <a class="btn btn-success"href="{{route('route_BackEnd_Category_Delete',['id'=>$item->id])}}">Xóa</a>
                                </td>
