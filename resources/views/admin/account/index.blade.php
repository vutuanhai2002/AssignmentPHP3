                    ...
                    <div class="col-xs-12" style="text-align:center;">
                        <div class="form-group">
                            ...
                            <a href="{{ url('/user') }}" class="btn btn-default btn-sm "><i class="fa fa-remove"></i>
                                Clear </a>
                            <a href="/admin/account/add" class="btn btn-info btn-sm"><i class="fa fa-user-plus" style="color:white;"></i>
                                Thêm mới</a>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($list as $item)
                            <tr>
                                ...
                                <td class="text-center"><img width="50px" src="{{asset('storage/'. $item->avatar)}}" alt=""></td>
                                <td class="text-center">{{$item->address}}</td>
                                <td class="text-center">{{$item->phone}}</td>
                                <td class="text-center">{{$item->role_name}}</td>
                                <td class="text-center">{{$item->status == 1 ?"Kích hoạt":"Chưa kích hoạt"}}</td>
                                <td>
                                    <a class="btn btn-danger"href="{{route('route_BackEnd_Account_Detail',['id'=>$item->id])}}">Sửa</a>
                                    <a class="btn btn-success"href="{{route('route_BackEnd_Account_Delete',['id'=>$item->id])}}">Xóa</a>
                                </td>
