                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="text" name="view" id="view" class="form-control" value="{{$objItem->view}}">
                                <span id="mes_sdt"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <input type="number" name="discount" id="discount" class="form-control" value="{{$objItem->discount}}">
                                <span id="mes_sdt"></span>
                            </div>
                        </div>
                        <div class="form-group">
