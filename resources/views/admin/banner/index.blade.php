                    ...
                    <div class="col-xs-12" style="text-align:center;">
                        <div class="form-group">
                            ...
                            <a href="{{ url('/user') }}" class="btn btn-default btn-sm "><i class="fa fa-remove"></i>
                                Clear </a>
                            <a href="/admin/banner/add" class="btn btn-info btn-sm"><i class="fa fa-user-plus" style="color:white;"></i>
                                Thêm mới</a>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($list as $item)
                            <tr>
                                ...
                                <td class="text-center"><a style="color:#333333;font-weight: bold;" href="" style="white-space:unset;text-align: justify;"> {{$item->title}} <i class="fa fa-edit"></i></a></td>
                                ...
                                <td>
                                    <a class="btn btn-danger"href="{{route('route_BackEnd_Banner_Detail',['id'=>$item->id])}}">Sửa</a>
                                    <a class="btn btn-success"href="{{route('route_BackEnd_Banner_Delete',['id'=>$item->id])}}">Xóa</a>
                                </td>
